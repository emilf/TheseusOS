...
## Next Steps
1. Investigate the EP0 transfer ring mismatch in QEMU (verify the deque pointer/DCS handshake, and consider issuing a Set TR Dequeue Pointer command) so the device descriptor transfer produces a valid event.
